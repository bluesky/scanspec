...
class Polygon(Region[Axis]):
    ...
    x_verts: List[float] = Field(
        description="The Nx1 x coordinates of the polygons vertices", json_schema_extra={"min_len": 3}
    )
    y_verts: List[float] = Field(
        description="The Nx1 y coordinates of the polygons vertices", json_schema_extra={"min_len": 3}
    )
...
class Circle(Region[Axis]):
    ...
    radius: float = Field(description="Radius of the circle", json_schema_extra={"exc_min": 0})
...
class Ellipse(Region[Axis]):
    ...
    x_radius: float = Field(
        description="The radius along the x axis of the ellipse", json_schema_extra={"exc_min": 0}
    )
    y_radius: float = Field(
        description="The radius along the y axis of the ellipse", json_schema_extra={"exc_min": 0}
    )
