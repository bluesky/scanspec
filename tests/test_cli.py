...
def test_plot_2D_line() -> None:
    ...
    # Turnaround
    assert_min_max_2d(lines[3], 2.5, 2.7537562, 1.9999821, 3.0000178)
    # Second row
...
def test_plot_3D_line() -> None:
    ...
    # Turnaround
    assert_min_max_3d(lines[3], 2.5, 2.7537562, 1.9999821, 3.0000178, 5, 5)
    # Second row
    ...
    # Turnaround
    assert_min_max_3d(lines[7], 0.2462437, 0.5, 3, 3, 4.9999821, 6.0000178)
    # Second grid
    # First row
    ...
    # Turnaround
    assert_min_max_3d(lines[11], 2.5, 2.7537562, 1.9999821, 3.0000178, 6, 6)
    # Second row
